...
- **URL:** https://react.dev/
- **Relevance:** The `judgment-ui` component library and the reference demonstration application (`apps/reference-demo`) are built with React. React provides the component model, state management, and rendering pipeline for the user interface.
